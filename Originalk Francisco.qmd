...
Método Newton-Raphson. Primera derivada $f'(x)= 2x-4$.
...
Método Newton-Raphson. Primera dervidad $f'(x) = 2x-4$
...
Consideremos $f(x)=2x^3-5x^2+x+2$
...
Primera derivada $f'(x)= \frac{1}{2√(x)} -cos(x)$
...
Método Newton-Raphson Primera derivada
funcion $f'(x)= \frac{1}{2√(x)} -cos(x)$
