...
author: "Francisco Vazquez Mendoza"
format: 
  html:
    grid: 
      body-width: 1000px
...
df_25 = nd.Derivative(f, step=0.30, method='central', order=2)
df_005 = nd.Derivative(f, step=0.06, method='central', order=2)


fig = go.Figure()

fig.add_trace(go.Scatter(x= x_values, y= df_25(x_values), mode='lines', name='h=0.30', line=dict(color='blue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= df_005(x_values), mode='lines', name='h=0.06', line=dict(color='black', width=1)))

fig.add_trace(go.Scatter(x= x_values, y= derivative(f, x_values).df, mode='lines', name='SciPy', line=dict(color='red', width=2)))

fig.add_trace(go.Scatter(x= x_values, y= derf(x_values), mode='lines', name='Derivada', line=dict(color='goldenrod', width=1)))

fig.update_layout(
    title="Aproximación de derivados",
    xaxis_title="x",
    yaxis_title="y",
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_25(x_values)), mode='lines+markers', name='h=0.25', line=dict(color='royalblue', width=2)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_005(x_values)), mode='lines+markers', name='h=0.05', line=dict(color='teal', width=1)))
...
fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_25(x_values), mode='lines', name='h=0.25', line=dict(color='green', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= ddf_005(x_values), mode='lines', name='h=0.05', line=dict(color='blue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= dderf(x_values), mode='lines', name='2da. derivada', line=dict(color='red', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_25(x_values)), mode='lines', name='h=0.25', line=dict(color='green', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_005(x_values)), mode='lines', name='h=0.05', line=dict(color='purple', width=1)))
...
plt.plot(x_values,  f(x_values), color = "purple", linewidth=2)
plt.grid()
plt.show()
```
...
fig.add_trace(go.Scatter(x= x_values, y= df_1(x_values), mode='lines', name='h=0.1', line=dict(color='red', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= df_25(x_values), mode='lines', name='h=0.25', line=dict(color='blue', width=1)))

fig.add_trace(go.Scatter(x= x_values, y= derivative(f, x_values).df, mode='lines', name='SciPy', line=dict(color='white', width=2)))

fig.add_trace(go.Scatter(x= x_values, y= derf(x_values), mode='lines', name='Derivada', line=dict(color='goldenrod', width=1)))

fig.update_layout(
    title="aproximación de las derivadas",
    xaxis_title="x",
    yaxis_title="y",
    template="plotly_white",
    width = 900,
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_1(x_values)), mode='lines+market', name='h=0.1', line=dict(color='green', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_25(x_values)), mode='lines', name='h=0.25', line=dict(color='yellow', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-derivative(f, x_values).df), mode='lines', name='SciPy', line=dict(color='brown', width=2)))
...
fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_1(x_values), mode='lines', name='h=0.2', line=dict(color='royalblue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= ddf_25(x_values), mode='lines', name='h=0.3', line=dict(color='yellow', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= dderf(x_values), mode='lines', name='2 derivada', line=dict(color='black', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_1(x_values)), mode='lines', name='h=0.2', line=dict(color='green', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_25(x_values)), mode='lines', name='h=0.25', line=dict(color='blue', width=1)))
...
plt.figure(figsize=(8,6))
plt.plot(x_values,  f(x_values), color = "green", linewidth=1.5)
plt.grid()
plt.show()
```
...
fig.add_trace(go.Scatter(x= x_values, y= df_01(x_values), mode='lines', name='h=0.2', line=dict(color='black', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= df_005(x_values), mode='lines', name='h=0.08', line=dict(color='blue', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_01(x_values)), mode='lines', name='h=0.2', line=dict(color='blue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-df_005(x_values)), mode='lines', name='h=0.08', line=dict(color='teal', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(derf(x_values)-derivative(f, x_values).df), mode='lines', name='SciPy', line=dict(color='green', width=2)))
...
fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_01(x_values), mode='lines', name='h=0.1', line=dict(color='yellow', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= ddf_005(x_values), mode='lines', name='h=0.05', line=dict(color='green', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= dderf(x_values), mode='lines', name='2 derivada', line=dict(color='goldenrod', width=1)))
...
fig.update_layout(
    title="errores segunda derivada",
    xaxis_title="x",
    yaxis_title="y",
    template="plotly_white",
    width = 900,
...
x_values = np.linspace(0, np.pi/2, 800)

plt.figure(figsize=(8,6))
plt.plot(x_values,  f(x_values), color = "black", linewidth=2)
plt.grid()
plt.show()
```
...
fig = go.Figure()
fig.add_trace(go.Scatter(x= x_values, y= ddf_125(x_values), mode='lines', name='h=0.125', line=dict(color='blue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= ddf_005(x_values), mode='lines', name='h=0.05', line=dict(color='green', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= dderf(x_values), mode='lines', name='2da. derivada', line=dict(color='red', width=1)))
...
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_125(x_values)), mode='lines', name='h=0.125', line=dict(color='blue', width=1)))
fig.add_trace(go.Scatter(x= x_values, y= abs(dderf(x_values)-ddf_005(x_values)), mode='lines', name='h=0.05', line=dict(color='green', width=1)))
...
plt.plot(x[puntos_in_negativo], y[puntos_in_negativo], 'o', color="red", label= "Puntos in -", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_positivo], y[puntos_out_positivo], 'o', color="blue", label= "Puntos out +", alpha=0.5, markersize=2.5)
plt.plot(x[puntos_out_negativo], y[puntos_out_negativo], 'o', color="purple", label= "Puntos out -", alpha=0.5, markersize=2.5)
plt.plot(x_values,f(x_values), color= "black", label="Función", linewidth=1.2)
plt.grid()
plt.legend()
plt.show()
...
x_values = np.linspace(0 , gamma.ppf(0.99, a), 800)
...
x_fill = np.linspace(a1,b1,300)

plt.figure(figsize=(8,6))
plt.plot(x_values, beta.pdf(x_values, a, b), label="Función de Densidad Beta", color="purple")
plt.fill_between(x_fill, 0, beta.pdf(x_fill, a, b), color="yellow", alpha=0.8)
